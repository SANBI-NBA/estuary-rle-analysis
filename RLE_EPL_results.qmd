...
est_results_vector <- est_v4 %>%
  left_join(est_results_for_integration, by = c("full_ecosystem_type_name" = "type"))
  #est_results_vector <- st_transform(est_results_vector, 4326)

st_write(est_results_vector, 
         "C:/Users/skownoa/Dropbox/NBAwork/Estuaries/est_results_vector.gpkg", 
         delete_layer = TRUE)
```
