...
|------------------------------------|------------------------------------|
| ![](outputs/rle24_est_barplot_count.jpeg) | ![](outputs/rle24_est_barplot_ext.jpeg) |
...
| RLIE |   |
|------------------------------------|------------------------------------|
| ![](outputs/rlie_est_line_plot.jpeg) | Red List Index of Ecosystems between 2018 and 2024. Showing increased risk of collapse for all estuary biogeographical zones. |
...
30% of estuary types (7/22) are highly threatened (EN/CR) and under protected (NP/ PP), 4 of these occur in the Cool Temperate biogeographical region

**RLE**

Count - 90% (20/22) threatened, 46% (10/22) EN or CR

Extent - 99% threatened, 73% EN or CR

**EPL**

Count - 54% (12/22) NP or PP; 13% NP

Extent - 41% PP NP, 10% NP
...
| Type | Status 2018 | Status 2025 | Change Log |
|------|-------------|-------------|------------|
|      |             |             |            |
|      |             |             |            |
|      |             |             |            |
